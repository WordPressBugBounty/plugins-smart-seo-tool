...
> 
> 1.SEO本身不是一件容易的事情，但当您深入了解其中的所有要点，也没有想象中那么深奥。
> 2.学习<a href="https://www.wbolt.com/learn/wp-seo?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="WordPress SEO教程">WordPress SEO</a>相关知识并实践(特别是<a href="https://www.wbolt.com/wordpress-seo-tips.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="WordPress SEO优化方案">WordPress SEO优化方案</a>)。
> 3.一般情况下，不建议将搜索页、标签页和作者页添加至索引，但应该设置跟随（即follow）。
> 4.推荐安装<a href="https://www.wbolt.com/plugins/skt?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="关键词插件">关键词推荐插件</a>，做好<a href="https://www.wbolt.com/keywords-seo-tips.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="关键词布局和优化">TDK关键词布局和优化</a>工作。
...
> ℹ️ <strong>Tips</strong> 
> 
> 1.<a href="https://www.wbolt.com/what-is-and-how-should-you-use-an-alt-tag.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="图片title和alt标签">图片title和alt标签</a>尽可能<a href="https://www.wbolt.com/add-title-alt-to-images-in-wordpress.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="手动填写ALT标签">手动填写</a>，勿忽视其重要性。
> 2."仅补充"即无ALT和Title时应用优化规则，"全覆盖"则全部应用优化规则。
...
> ℹ️ <strong>Tips</strong> 
> 
> 1.<a href="https://www.wbolt.com/internal-links-optimization.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="内部链接优化">内部链接优化</a>是SEO重要组成部分，也是<a href="https://www.wbolt.com/linkbait.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="链接诱饵">链接诱饵</a>一种方式。
> 2.外部链接应该<a href="https://www.wbolt.com/what-is-nofollow.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="添加Nofollow属性">添加Nofollow属性</a>，防止页面权重分发其他站点。
> 3.站长可以查阅SEO优化技巧之<a href="https://www.wbolt.com/seo-link-building-tips.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="网站链接建设">网站链接建设</a>，并加以实践。
...
404监测列表数据包括URL地址、响应码、反馈蜘蛛、访问时间及操作项（刷新状态及忽略）。

> ℹ️ <strong>Tips</strong> 
> 
> 1.<a href="https://www.wbolt.com/guide-to-wp-404-pages.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="404响应码">404响应码</a>不代表网站一定存在该链接，可能是安全扫描、爬虫等程序导致。
> 2.为协助您更好地判断404错误，建议安装<a href="https://www.wbolt.com/plugins/spider-analyser?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="蜘蛛分析插件">蜘蛛分析插件</a>。
> 3.对于真实的404状态链接，可以安装<a href="https://www.wbolt.com/plugins/bsl-pro?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="搜索推送插件">搜索推送插件</a>生成404链接集URL，提交通知搜索引擎。
...
> ℹ️ <strong>Tips</strong> 
> 
> 1.部分异常链接可能是国内无法访问该站点导致，建议将此类域添加至排除域名列表。
> 2.对应<a href="https://www.wbolt.com/wordpress-redirect.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="重定向链接">重定向链接</a>，建议将该URL修改为最终URL。
> 3.部分服务器会拒绝系统检测访问，返回<a href="https://www.wbolt.com/how-to-fix-a-403-forbidden-error.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="403响应码">403</a>或者<a href="https://www.wbolt.com/how-to-fix-a-403-forbidden-error.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="503响应码">503</a>状态，此种情况无需理会。
...
> ℹ️ <strong>Tips</strong> 
> 
> 1.<a href="https://www.wbolt.com/wordpress-redirect.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="WordPress重定向最佳实践">WordPress重定向最佳实践</a>能够最大化SEO和提升页面速度。
> 2.关于301永久重定向或者302临时重定向，可以阅读<a href="https://www.wbolt.com/301-redirects.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="301重定向与SEO之间的关系">了解301重定向与SEO之间的关系</a>和<a href="https://www.wbolt.com/301-or-302-redirects.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="基于SEO应选择301还是302">基于SEO应选择301还是302</a>。
> 3.如果大量链接规则变更，建议添加规则进行匹配重定向，比如分类news变更为blog，则可以添加301重定向规则：*/news/(*) 重定向至 */blog/$1。
...
> ℹ️ <strong>Tips</strong> 
> 
> 1.百度、360搜索及头条搜索均不支持sitemap通知，但可以手动提交sitemap。
> 2.不同搜索引擎Sitemap提交教程：<a href="https://www.wbolt.com/submit-sitemap-url-to-baidu.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="百度搜索资源平台">百度搜索资源平台</a>，<a href="https://www.wbolt.com/how-to-add-a-sitemap-to-bing-webmaster.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="Bing网站管理工具">Bing网站管理工具</a>，<a href="https://www.wbolt.com/google-search-console.html#how-to-add-a-sitemap-in-google-search-console?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="谷歌搜索控制台">谷歌搜索控制台</a>，<a href="https://www.wbolt.com/how-to-add-a-sitemap-to-360-zhanzhang.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="360站长平台">360站长平台</a>及<a href="https://www.wbolt.com/how-to-set-a-sitemap-linksubmit-for-toutiao.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="头条搜索站长平台">头条搜索站长平台</a>。
> 3.为了提升推送效果，建议安装<a href="https://www.wbolt.com/plugins/bsl-pro?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="搜索推送插件">搜索推送插件</a>，以多种方式同时提交URL至搜索引擎。
> 4.一般不建议将独立页面、标签页及作者页列入Sitemap，站长需结合自身情况取舍。
...
> ℹ️ <strong>Tips</strong> 
> 
> 1.robots.txt用于告知搜索引擎页面链接是否允许爬取或者索引。
> 2.确保未激活其他robots.txt生成器，且需删除网站目录robots.txt文件，否则设置无法生效。
> 3.您可以通过<a href="https://www.wbolt.com/tools/robots-tester?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="Robots在线工具">Robots在线工具</a>来校验robots.txt规则是否合规及检测URL是否拦截蜘蛛爬取。
> 4.参考教程：<a href="https://www.wbolt.com/optimize-wordpress-robots-txt.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="编写和优化WordPress网站的Robots.txt">如何编写和优化WordPress网站的Robots.txt</a>和<a href="https://www.wbolt.com/robots-txt.html?utm_source=wp&utm_medium=link&utm_campaign=sst" rel="friend" title="如何规范地编写Robots.txt">深入了解Robots.txt及如何规范地编写</a>
...
* 优化文章编辑SEO设置模块样式及交互。
* 修正TDK字段带单引号(‘)保存异常问题。
* 设置界面技术升级，目录梳理，细节交互优化。

= 4.0.7 =
* 增加Sitemap地址不存在时响应404状态码；
* 修复TDK变量报错问题；
* 修复Sitemap生成报错问题。
...
* 增加重定向模块开关；
* 优化TDK变量和文本输入交互体验；
* 优化Title分隔符前后增加英文字符空格；
* 优化网站地图模块js读取性能；
* 优化插件配置向导步骤体验；
* 修复页面和文章编辑无法调取关键词插件下拉关键词的bug；
* 修复TDK预览数据为空时PHP报错；
* 移除列表关键词变量支持。

= 4.0.2 =
* 修复Windows系统下robots.txt不换行bug；
* 插件增加csrf安全防护；
* 移除列表关键词变量支持。

= 4.0.1 =
* 优化TDK功能模块，支持SST插件引入、搜索引擎跟随及分类目录下拉分级展示；
* 优化sitemap内容表单：列表对齐、名称、子地图生成及子地图分组；
* 优化robots.txt：增加重置支持及加入校验快捷方式；
* 新增模块温馨提示，便于站长快速了解功能模块；
* 修复失效URL检测功能模块bug：检测范围和定时检测无效问题；
* 修复站长工具验证无效bug；
* 其他样式及用户体验优化。
...
* 新增重定向链接管理功能模块；
* 新增站长工具验证功能模块；
* 新增Sitemap子地图按数据条目分拆方式；
* 新增Sitemap冲突检测支持；
* 新增WordPress默认Sitemap开关；
* 新增图片优化变量注释说明；
* 优化搜索结果页、标签列表页和作者列表页自动关键词规则；
* 优化文章和独立页面预览数据为读取真实数据。

= 3.1.2 =
* 优化404监测列表，支持批量刷新及忽略状态；
* 新增404监测列表说明文字；
* 修复失效URL检测无效问题；
* 新增待检测tab标签列表，取消正常链接tab标签列表；
* 增加无效URL说明文字。
